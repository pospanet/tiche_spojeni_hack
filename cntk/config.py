...
#    __C.CNTK.NUM_TRAIN_IMAGES = 100
#    __C.CNTK.NUM_TEST_IMAGES = 5
    __C.CNTK.NUM_TRAIN_IMAGES = ch.getNumberOfTrainImages(__C.CNTK.MAP_FILE_PATH)
    __C.CNTK.NUM_TEST_IMAGES = ch.getNumberOfTestImages(__C.CNTK.MAP_FILE_PATH)
